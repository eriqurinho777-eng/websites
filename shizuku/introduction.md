...
3. (pre-Pie) Start the Java process with app_process ([see here](https://android.googlesource.com/platform/frameworks/base/+/oreo-radb shell sh /storage/emulated/0/Android/data/moe.shizuku.privileged.api/start.shelease/cmds/pm/pm))
